...
export default function Sidebar(){
    return(
        <div className="hidden pb-[30px] fixed h-full w-[240px] text-white border-r-[0.07rem] border-[#2e2e2e] md:flex flex-col items-center alternate hover:overlay  overflow-y-scroll  hover:overflow-x-hidden">
